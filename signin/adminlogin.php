...
<body>
    <div class="container">
        <div class="signinform">
            ...
            <form name="loginform" action="../includes/adminlogin.inc.php" method="POST">
            ...
            <div class="form-group">
                ...
                <button onclick="return validateForm()" id="loginbtn" name="login" type="submit" class="btn btn-success">Log in</button>
            </form>
            <a class="btn btn-info mt-3" style="text-decoration: none; color: white;" href="login.php">Log in as User</a>
        </div>
    </div>
